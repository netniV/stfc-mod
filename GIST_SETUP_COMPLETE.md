...
| `player.ops_level`, `player.syndicate_level`, drydock assignments, ships, research, resources, officers, missions, faction, buffs, territory | Arrives automatically at login — no action needed |
