...
namespace Graphics
{
  ...
  constexpr const char* fleet_label_player_detail             = "native";
  constexpr auto        fleet_label_player_zoom_threshold     = 0.5;
  constexpr const char* fleet_label_non_player_detail         = "native";
  constexpr auto        fleet_label_non_player_zoom_threshold = 0.5;
